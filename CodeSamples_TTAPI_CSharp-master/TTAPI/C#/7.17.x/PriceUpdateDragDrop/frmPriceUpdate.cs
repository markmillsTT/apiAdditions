    ...
    public partial class frmPriceUpdate : Form
    {
        ...
        public void ttApiInitHandler(TTAPI api, ApiCreationException ex)
        {
            if (ex == null)
            {
                ...
                m_TTAPI.Session.CurrencyUpdated += new EventHandler<CurrencyUpdatedEventArgs>(curr_updated);
        ...
        ///  
        /// </summary>
        private void curr_updated(object sender, CurrencyUpdatedEventArgs e)
        {
            Console.WriteLine();
        }
