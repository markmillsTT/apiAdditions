...
namespace TTAPI_Sample_Console_TimeAndSales
{
    ...
    class TTAPIFunctions : IDisposable
    {
        ...
        //Mark Mills Change
        private string instrumentName = "Jun16";
        private string productName = "ES";
        ...
        public void apiInstance_AuthenticationStatusUpdate(object sender, AuthenticationStatusUpdateEventArgs e)
        {
            if (e.Status.IsSuccess)
            {
                ...
                m_req = new InstrumentLookupSubscription(m_apiInstance.Session, Dispatcher.Current,
                    new ProductKey(MarketKey.Cme, ProductType.Future, this.productName),
                    this.instrumentName);
        ...
        void m_ts_Update(object sender, TimeAndSalesEventArgs e)
        {
            ...
            EMAIL: HONGJING ZOU - April 14th 8 P.M.

            I am using TT API. For each TimeAndSales Update, I will receive a collection of TimeAndSalesData. 
            Foreach TimeAndSalesData, I can get price, quantity, direction, and trade time. 

            QUESTION:
            Is there any way I can get the number of orderIdEntries in that trade? 
