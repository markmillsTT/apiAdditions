...
//Worknotes
// - check if you can get child orders (spread legs) to come through some fill event handler.
...
namespace TTAPI_Samples
{
    ...
    public partial class frmOrderUpdate : Form
    {
        ...
        void m_TTAPI_AuthenticationStatusUpdate(object sender, AuthenticationStatusUpdateEventArgs e)
        {
            ...
            m_tradeSubscription = new TradeSubscription(m_TTAPI.Session, Dispatcher.Current, true, false, true, true);
            ...
            m_tradeSubscription.FillBookDownload += new EventHandler<FillBookDownloadEventArgs>(fillBookDownload);
            m_tradeSubscription.FillRecordAdded += new EventHandler<FillAddedEventArgs>(fillAddedEventHandler);
        ...
        private void fillAddedEventHandler(object sender, FillAddedEventArgs e)
        {
            UpdateStatusBar("Fill Added");
        }

        private void fillBookDownload(object sender, FillBookDownloadEventArgs e)
        {
            UpdateStatusBar("Fillbook Download");
        }
        ...
        {
            OrderProfileBase oldProfile = e.OldOrder.GetOrderProfile();
            OrderProfileBase newProfile = e.NewOrder.GetOrderProfile();
