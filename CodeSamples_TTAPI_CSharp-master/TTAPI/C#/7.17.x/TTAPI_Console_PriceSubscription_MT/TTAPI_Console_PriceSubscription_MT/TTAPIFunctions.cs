    ...
    class TTAPIFunctions : IDisposable
    {
        ...
        public void apiInstance_AuthenticationStatusUpdate(object sender, AuthenticationStatusUpdateEventArgs e)
        {
            if (e.Status.IsSuccess)
            {
                ...
                lcd1.Add(new ContractDetails(MarketKey.Cme, ProductType.Future, "ES", "Dec16"));
                lcd1.Add(new ContractDetails(MarketKey.Cme, ProductType.Future, "NQ", "Dec16"));
                ...
                lcd2.Add(new ContractDetails(MarketKey.Cme, ProductType.Future, "ES", "Mar16")); 
                //lcd2.Add(new ContractDetails(MarketKey.Cbot, ProductType.Future, "ZB", "Dec16"));
                //lcd2.Add(new ContractDetails(MarketKey.Cbot, ProductType.Future, "ZN", "Dec16"));
                // [TS_INFO]
